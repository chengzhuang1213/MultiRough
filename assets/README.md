...
This folder contains art resources used by the Godot project.

## Tiny Swords Free Pack

Imported from the user-provided archive:

`C:\Users\cheng\Downloads\Tiny Swords (Free Pack).zip`

Project resource root:

`res://assets/tiny_swords_free_pack/`

The archive was extracted without macOS metadata files such as `__MACOSX`, `.DS_Store`, and `._*`.

Top-level folders currently available:
